 ...
 *         Created on 15/6/30.
 */
public class DubboInvokeLineChartV2 implements Serializable {
    ...
    private List<LineChartSeriesV2> seriesData;
    ...
    public List<LineChartSeriesV2> getSeriesData() {
        return seriesData;
    }

    public void setSeriesData(List<LineChartSeriesV2> seriesData) {
