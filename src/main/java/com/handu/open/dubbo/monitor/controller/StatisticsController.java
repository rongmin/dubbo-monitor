    ...
    public String index(@ModelAttribute DubboInvoke dubboInvoke, Model model) {
        ...
        for (String method : methods) {
            ...
            for (DubboInvoke di : dubboInvokes) {
                ...
                dubboStatistics.setProviderAvgElapsed(di.getSuccess() != 0 ? Double.valueOf(String.format("%.4f", 1.0*di.getElapsed() / di.getSuccess())) : 0);
            ...
            for (DubboInvoke di : dubboInvokes) {
                ...
                dubboStatistics.setConsumerAvgElapsed(di.getSuccess() != 0 ? Double.valueOf(String.format("%.4f", 1.0*di.getElapsed() / di.getSuccess())) : 0);
